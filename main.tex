...
\newcommand{\mystudy}{Technische Informatik} %% your study like ``Arts''
\newcommand{\myuniversity}{Hochschule Pforzheim} %% your university/school
\newcommand{\myinstitute}{Fakultät für Technik} %% affiliation
...
%% template for inserting inkscape figures:
% more information: http://genug-davon.de/more/index.php?section=inkscape
...
% Verweise auf Kapitel mit \nameref{labelname}
% Verweise auf Abbildungen mit \ref{labelname}
% Verweise auf Seiten mit \pageref{labelname}
%
...
\input{Chapter2-TheorieDeflektometrie} 
\input{Chapter3-RealisierungDesAnsatzes}
\input{Chapter4-DatenAuswertung}  
\input{Chapter5-Hilfsprogramme}  
